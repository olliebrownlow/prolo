import { getCoin, getCurrencySettings, getCryptoData } from "../../actions";

export const getSingleCoinData = async (targetCoinCode, user) => {
  const coin = await getCoin({ code: targetCoinCode, user: user });
